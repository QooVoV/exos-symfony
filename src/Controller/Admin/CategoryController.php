...
class CategoryController extends AbstractController
{
  ...
  public function addNew(Request $request, CategoryRepository $repository): Response {
    ...
    return $this->render('admin/category/addNew.html.twig');
  }
  ...
  public function update(Request $request, CategoryRepository $repository, int $id) : Response {
    ...
    return $this->render('admin/category/update.html.twig', ['category'=>$category]);
  }
